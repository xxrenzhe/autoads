...
http {
    ...
    # 上游服务器
    upstream autoads_backend {
        least_conn;
        server autoads-service-1:8080 weight=1;
        server autoads-service-2:8080 weight=1;
        server autoads-service-3:8080 weight=1;
        keepalive 32;
    }
    ...
    server {
        ...
        ssl_certificate /etc/nginx/ssl/autoads.com.crt;
        ssl_certificate_key /etc/nginx/ssl/autoads.com.key;
        ...
        # 代理配置
        location / {
            proxy_pass http://autoads_backend;
