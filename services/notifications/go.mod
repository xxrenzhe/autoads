module github.com/xxrenzhe/autoads/services/notifications
...
require (
	...
	github.com/xxrenzhe/autoads/pkg/auth v0.0.1 // indirect
	github.com/xxrenzhe/autoads/pkg/idempotency v0.0.0-20250925163018-6150a4965e27 // indirect
