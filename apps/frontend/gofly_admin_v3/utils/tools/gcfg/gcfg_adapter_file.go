...
import (
	...
	"gofly-admin-v3/utils/tools/gfsnotify"
	"gofly-admin-v3/utils/tools/gres"
	"gofly-admin-v3/utils/tools/intlog"

	"gofly-admin-v3/utils/tools/gmode"
...
var (
	...
	resourceTryFolders = []string{
		...
		"resource/config/", "resource/config", "/resource/config", "/resource/config/",
	}

	// Prefix array for trying searching in the local system.
	localSystemTryFolders = []string{"", "resource/", "resource/config"}
)
