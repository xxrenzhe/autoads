// Package gform provides ORM features for popular relationship databases.
//
...
import (
	...
	"gofly-admin-v3/utils/tools/gcmd"
...
// Driver is the interface for integrating sql drivers into package gform.
...
const (
	...
	commandEnvKeyForDryRun                = "gf.gform.dryrun"
...
// Register registers custom database driver to gform.
