...
func (m *MockSimilarWebClient) GetDomainRank(domain, country string) (*SiteRankData, error) {
	...
	case "google.com":
		return &SiteRankData{
			...
			Country:       "world",
			Visits:        float64Ptr(15000000000), // 150亿访问量 - 超高流量
	...
	case "facebook.com":
		return &SiteRankData{
			...
			Country:       "world",
			Visits:        float64Ptr(8000000000), // 80亿访问量 - 超高流量
	...
	case "youtube.com":
		return &SiteRankData{
			...
			Country:       "world",
			Visits:        float64Ptr(12000000000), // 120亿访问量 - 超高流量
			BounceRate:    float64Ptr(0.15),
			PagesPerVisit: float64Ptr(15.2),
			AvgDuration:   float64Ptr(1800),
		}, nil
	case "amazon.com":
		return &SiteRankData{
			GlobalRank:    intPtr(15),
			CategoryRank:  intPtr(1),
			Category:      "E-commerce",
			Country:       "world",
			Visits:        float64Ptr(2500000000), // 25亿访问量 - 高流量
			BounceRate:    float64Ptr(0.40),
			PagesPerVisit: float64Ptr(9.8),
			AvgDuration:   float64Ptr(480),
		}, nil
	case "wikipedia.org":
		return &SiteRankData{
			GlobalRank:    intPtr(8),
			...
			Category:      "Reference",
			Country:       "world",
			Visits:        float64Ptr(1800000000), // 18亿访问量 - 高流量
			BounceRate:    float64Ptr(0.65),
			PagesPerVisit: float64Ptr(2.1),
			AvgDuration:   float64Ptr(240),
		}, nil
	case "github.com":
		return &SiteRankData{
			GlobalRank:    intPtr(45),
			CategoryRank:  intPtr(2),
			Category:      "Technology",
			Country:       "world",
			Visits:        float64Ptr(350000000), // 3.5亿访问量 - 中高流量
			BounceRate:    float64Ptr(0.55),
			PagesPerVisit: float64Ptr(4.2),
			AvgDuration:   float64Ptr(320),
		}, nil
	case "stackoverflow.com":
		return &SiteRankData{
			GlobalRank:    intPtr(180),
			CategoryRank:  intPtr(5),
			Category:      "Technology",
			Country:       "world",
			Visits:        float64Ptr(85000000), // 8500万访问量 - 中流量
			BounceRate:    float64Ptr(0.70),
			PagesPerVisit: float64Ptr(2.8),
			AvgDuration:   float64Ptr(280),
		}, nil
	case "medium.com":
		return &SiteRankData{
			GlobalRank:    intPtr(320),
			CategoryRank:  intPtr(15),
			Category:      "News & Media",
			Country:       "world",
			Visits:        float64Ptr(45000000), // 4500万访问量 - 中流量
			BounceRate:    float64Ptr(0.60),
			PagesPerVisit: float64Ptr(2.5),
			AvgDuration:   float64Ptr(200),
		}, nil
	case "example.com":
		return &SiteRankData{
			...
			Category:      "Technology",
			Country:       "world",
			Visits:        float64Ptr(100000), // 10万访问量 - 低流量
	...
	case "small-blog.com":
		return &SiteRankData{
			...
			CategoryRank:  intPtr(25000),
			Category:      "Personal Blog",
			Country:       "world",
			Visits:        float64Ptr(5000), // 5000访问量 - 很低流量
			BounceRate:    float64Ptr(0.80),
			PagesPerVisit: float64Ptr(1.8),
			AvgDuration:   float64Ptr(90),
		}, nil
	case "high-traffic-low-rank.com":
		// 测试用例：高流量但排名较低的网站
		return &SiteRankData{
			GlobalRank:    intPtr(150000),
			CategoryRank:  intPtr(5000),
			Category:      "Entertainment",
			Country:       "world",
			Visits:        float64Ptr(50000000), // 5000万访问量 - 高流量但排名低
			BounceRate:    float64Ptr(0.50),
			PagesPerVisit: float64Ptr(4.0),
			AvgDuration:   float64Ptr(300),
		}, nil
	case "low-traffic-high-rank.com":
		// 测试用例：低流量但排名较高的网站
		return &SiteRankData{
			GlobalRank:    intPtr(5000),
			CategoryRank:  intPtr(50),
			Category:      "Business",
			Country:       "world",
			Visits:        float64Ptr(200000), // 20万访问量 - 低流量但排名高
			BounceRate:    float64Ptr(0.30),
			PagesPerVisit: float64Ptr(6.5),
			AvgDuration:   float64Ptr(450),
		}, nil
	default:
		// 未知域名返回错误
