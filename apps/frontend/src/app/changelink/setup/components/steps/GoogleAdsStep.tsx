          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('loginCustomerId', e.target.value)}
                className="w-full px-3 py-2 border rounded-md"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('clientSecret', e.target.value)}
                className="w-full px-3 py-2 border rounded-md"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('developerToken', e.target.value)}
                className="w-full px-3 py-2 border rounded-md"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('refreshToken', e.target.value)}
                className="w-full px-3 py-2 border rounded-md"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleInputChange('customerId', e.target.value)}
                className="w-full px-3 py-2 border rounded-md"
                placeholder="123-456-7890&#10;234-567-8901&#10;345-678-9012"
                rows={3}
              />
