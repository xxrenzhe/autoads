          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e: any) => handleConfigUpdate({ enabled: e.target.checked })}
              />
            }
            label="Enabled"
          />
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <TextField
              ...
              onChange={(e: any) => handleConfigUpdate({ maxConcurrentTasks: parseInt(e.target.value) })}
              fullWidth
              margin="normal"
            ...
            <TextField
              ...
              onChange={(e: any) => handleConfigUpdate({ rateLimitPerMinute: parseInt(e.target.value) })}
              fullWidth
              margin="normal"
              disabled={!localConfig.enabled}
            />
            ...
            <TextField
              ...
              onChange={(e: any) => handleConfigUpdate({ timeoutSeconds: parseInt(e.target.value) })}
              fullWidth
              margin="normal"
              disabled={!localConfig.enabled}
            />
            ...
            <TextField
              ...
              onChange={(e: any) => handleConfigUpdate({ retryAttempts: parseInt(e.target.value) })}
              fullWidth
              margin="normal"
              disabled={!localConfig.enabled}
            />
          ...
          <Grid item xs={12} md={6}>
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e: any) => handleConfigUpdate({ cacheEnabled: e.target.checked })}
                  disabled={!localConfig.enabled}
                />
              }
              label="Cache Enabled"
            ...
            <TextField
              ...
              onChange={(e: any) => handleConfigUpdate({ cacheTtlMinutes: parseInt(e.target.value) })}
              fullWidth
              margin="normal"
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e: any) => handleConfigUpdate({ debugMode: e.target.checked })}
                  disabled={!localConfig.enabled}
                />
              }
              label="Debug Mode"
...
export const BusinessModuleConfig: React.FC = () => {
  ...
  return (
    <Box>
      ...
      <Tabs
        value={activeTab}
        onChange={(_e, newValue) => setActiveTab(newValue as number)}
        sx={{ mb: 3 }}
      >
