          ...
          <Box>
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                onChange={(e) => setActionData({ ...actionData, immediate: (e.target as any).value === 'true' })}
                label="取消方式"
              >
            ...
            <TextField
              ...
              onChange={(e) => setActionData({ ...actionData, reason: (e.target as any).value })}
            />
          </Box>
        );
        ...
        return (
          <Box>
            <TextField
              ...
              onChange={(e) => setActionData({ ...actionData, duration: parseInt((e.target as any).value) || 30 })}
            />
            <FormControl fullWidth margin="normal">
              <InputLabel>续费方式</InputLabel>
              <Select
                value={String(actionData.extendCurrent || true)}
                onChange={(e) => setActionData({ ...actionData, extendCurrent: (e.target as any).value === 'true' })}
                label="续费方式"
              >
        ...
        return (
          <Box>
            <TextField
              ...
              onChange={(e) => setActionData({ ...actionData, newPlanId: (e.target as any).value })}
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                onChange={(e) => setActionData({ ...actionData, prorate: (e.target as any).value === 'true' })}
                label="是否按比例计费"
              >
        ...
        return (
          <Box>
            <TextField
              ...
              onChange={(e) => setActionData({ ...actionData, amount: parseFloat((e.target as any).value) || 0 })}
        ...
        return (
          <Box>
            <TextField
              ...
              onChange={(e) => setActionData({ ...actionData, pauseDuration: parseInt((e.target as any).value) || 7 })}
            />
