              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      {getTypeOptions()?.filter(Boolean)?.map(option => (
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    {getEnvironmentOptions()?.filter(Boolean)?.map(option => (
                      <option key={option.value} value={option.value}>
                        {option.label}
                      </option>
                    ))}
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleValidationChange('enum', e.target.value ? e.target.value.split(',')?.filter(Boolean)?.map(v => v.trim()) : undefined)}
