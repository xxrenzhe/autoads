...
const pathToTitleMap: Record<string, string> = {
  ...
  '/admin': 'Admin Panel',
  '/ops/console/users': 'User Management',
  '/ops/console/security': 'Security',
  '/ops/console/monitoring': 'Monitoring',
  '/ops/console/tokens': 'Token Configuration',
  '/ops/console/tokens/analytics': 'Token Analytics',
  '/pricing': 'Pricing',
  '/features': 'Features',
  '/settings': 'Settings'
}
