...
8. WHEN 系统检测到账号风险 THEN 系统 SHALL 识别并预警：Ads账号被封禁、广告主认证触发、Offer URL无法解析、广告被拒绝、广告受限等风险类型
9. WHEN 风险预警触发 THEN 系统 SHALL 根据后台配置的风险识别策略执行相应的处理流程
10. WHEN 检测到Offer URL解析失败 THEN 系统 SHALL 立即暂停相关的换链接任务并通知用户### 需求7
：机会发现与扩展系统
...
8. WHEN 系统扩展 THEN 系统 SHALL 保持技术栈的一致性和可维护性## 上瘾体验设计
总结
