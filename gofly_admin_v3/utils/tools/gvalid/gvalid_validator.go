...
type Validator struct {
	...
	localeType                        string              // Returns the prompt language type
}
...
// Locale is set the return prompt language type
func (v *Validator) Locale(data string) *Validator {
	newValidator := v.Clone()
	newValidator.localeType = data
	return newValidator
}
